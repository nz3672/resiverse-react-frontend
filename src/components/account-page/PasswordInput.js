  ...
  return (
    <div className="flex flex-row w-full pt-4 text-xl ">
      ...
      <div className="basis-1/4  flex mr-2">
        <input
          type="password"
          className="w-full bg-[#fae6e8] text-lg rounded-lg border-[1px] border-[#cdd9e5]/50 focus:outline-0 focus:border-pink-500/75 focus:border-[1px] py-1 pl-2 mr-1 focus:ring-0"
