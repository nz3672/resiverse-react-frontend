const Widget = (props) => {
  ...
  return (
    <div
      key={i}
      className="cursor-pointer hover-widget hover:bg-pink-500 rounded-3xl shadow-xl w-[280px] h-[370px] bg-white hover:z-100 bg-opacity-50 laptop:pb-4 laptop:px-4 laptop:pt-5 pb-2 px-2 pt-2"
    >
